          ...
          >
            ...
            >
              ...
              {items.slice(0, -1).map((row, index) => {
                ...
                const leftAccent = roadmapAccentFor(index);
                const rightAccent = roadmapAccentFor(index + 1);
                return (
                  <span
                    ...
                    style={{
                      left: `${left}%`,
                      width: `${right - left}%`,
                      "--tr-rm-seg-a": leftAccent,
                      "--tr-rm-seg-b": rightAccent,
                    } as any}
                    aria-hidden="true"
                  />
                );

...
export function PreWorkoutLaunch({
  ...
  function refreshMotivation() {
    ...
    if (videos.length) setSelectedVideo(pickMotivationVideo(videos));
  }
  ...
  return (
    <section className="tr-preLaunch" aria-label="Pre-workout launch">
      ...
      <style>{`
        ...
        .tr-preLaunchOrb{position:absolute;border-radius:50%;filter:blur(55px);opacity:.58;mix-blend-mode:screen;will-change:transform}
        .tr-preLaunchOrb--a{width:38vw;height:38vw;left:-12vw;top:8%;background:radial-gradient(circle,rgba(0,194,255,.30),rgba(0,104,255,.04) 66%,transparent 72%);animation:trLaunchFloatA 12s ease-in-out infinite alternate}
        .tr-preLaunchOrb--b{width:34vw;height:34vw;right:-10vw;top:16%;background:radial-gradient(circle,rgba(255,102,26,.20),rgba(255,30,0,.03) 68%,transparent 74%);animation:trLaunchFloatB 15s ease-in-out infinite alternate}
        .tr-preLaunchOrb--c{width:28vw;height:28vw;left:42%;bottom:-17vw;background:radial-gradient(circle,rgba(25,224,180,.13),rgba(0,174,255,.02) 66%,transparent 72%);animation:trLaunchFloatC 17s ease-in-out infinite alternate}
        .tr-preLaunchSweep{position:absolute;inset:-30% -40%;background:conic-gradient(from 210deg at 50% 50%,transparent 0 37%,rgba(104,223,255,.055) 44%,transparent 51% 100%);animation:trLaunchSweep 15s linear infinite}
        ...
        .tr-preLaunchNoise{position:absolute;inset:0;opacity:.11;background-image:radial-gradient(circle at 20% 30%,rgba(255,255,255,.45) 0 .7px,transparent .8px),radial-gradient(circle at 80% 70%,rgba(255,255,255,.35) 0 .6px,transparent .7px);background-size:7px 7px,11px 11px;animation:trLaunchNoise 7s steps(2,end) infinite}
        ...
        .tr-preLaunchTopbar{position:relative;z-index:3;display:flex;align-items:center;justify-content:space-between;gap:16px;padding:21px 24px 17px;border-bottom:1px solid rgba(255,255,255,.075);background:linear-gradient(180deg,rgba(5,12,18,.88),rgba(5,12,18,.42));backdrop-filter:blur(14px)}
        ...
        .tr-preLaunchHero{position:relative;min-height:470px;display:grid;place-items:center;overflow:hidden}
        .tr-preLaunchVideoStage{position:absolute;inset:0;display:grid;place-items:center;overflow:hidden;background:#020406}
        .tr-preLaunchVideo{width:100%;height:100%;display:block;object-fit:cover;filter:saturate(.88) contrast(1.08) brightness(.76)}
        ...
        .tr-preLaunchVideoVignette{position:absolute;inset:0;background:linear-gradient(90deg,rgba(2,6,10,.92) 0%,rgba(2,6,10,.30) 31%,rgba(2,6,10,.20) 50%,rgba(2,6,10,.35) 69%,rgba(2,6,10,.94) 100%),linear-gradient(180deg,rgba(2,6,10,.12),rgba(2,6,10,.15) 48%,rgba(2,6,10,.90) 100%);pointer-events:none}
        ...
        .tr-preLaunchMotivation p{margin:3px 0 0;max-width:720px;color:rgba(239,246,250,.88);font-size:clamp(15px,2vw,22px);line-height:1.35;font-weight:750;text-wrap:balance;animation:trLaunchSpeechIn .75s .12s ease-out both}
        ...
        .tr-preLaunchRefresh{margin-top:9px;height:35px;padding:0 13px;border:1px solid rgba(180,229,246,.20);border-radius:999px;color:rgba(218,239,247,.72);background:rgba(3,9,14,.42);font-size:8px;font-weight:1000;letter-spacing:.14em;cursor:pointer;backdrop-filter:blur(8px)}
        .tr-preLaunchRefresh:hover{border-color:rgba(84,208,255,.46);color:#dff7ff}
        .tr-preLaunchCommandDeck{position:relative;z-index:4;display:grid;gap:13px;padding:16px 19px 20px;border-top:1px solid rgba(255,255,255,.075);background:linear-gradient(180deg,rgba(4,9,14,.75),rgba(3,7,11,.985));backdrop-filter:blur(16px)}

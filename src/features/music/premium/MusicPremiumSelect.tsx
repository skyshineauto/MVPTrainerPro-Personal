  ...
  return (
    <div ref={rootRef} className={`mvpPremiumSelect ${open ? "is-open" : ""} ${disabled ? "is-disabled" : ""} ${className}`.trim()}>
      ...
      <style>{`
        ...
        .mvpPremiumSelectTrigger{width:100%;min-height:44px;padding:0 13px;display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid rgba(86,185,216,.22);border-radius:10px;background:linear-gradient(180deg,#071923,#030d12);color:#eefbff;box-shadow:inset 0 1px rgba(255,255,255,.035),0 8px 18px rgba(0,0,0,.13);cursor:pointer;text-align:left;transition:filter .16s ease,border-color .16s ease,box-shadow .16s ease,transform .16s ease}
        ...
        .mvpPremiumSelectMenu{position:absolute;left:0;right:0;top:calc(100% + 7px);max-height:min(310px,55vh);overflow:auto;padding:6px;border:1px solid rgba(82,199,235,.25);border-radius:12px;background:radial-gradient(260px 120px at 0 0,rgba(55,203,245,.10),transparent 70%),linear-gradient(180deg,rgba(5,18,24,.995),rgba(2,9,13,.998));box-shadow:0 24px 65px rgba(0,0,0,.58),inset 0 1px rgba(255,255,255,.04);backdrop-filter:blur(24px);scrollbar-width:thin;scrollbar-color:#1f5364 #061219}
        ...
        .mvpPremiumSelectMenu>button:hover,.mvpPremiumSelectMenu>button:focus-visible{outline:0;color:#f2fcff;border-color:rgba(81,213,251,.26);background:linear-gradient(90deg,rgba(19,73,90,.62),rgba(7,28,36,.78));box-shadow:inset 2px 0 #42d8ff}
        .mvpPremiumSelectMenu>button.is-selected{color:#eaffff;border-color:rgba(76,219,255,.32);background:radial-gradient(180px 55px at 0 50%,rgba(61,215,253,.16),transparent 75%),linear-gradient(90deg,#0a2732,#06151c);box-shadow:inset 2px 0 #48dcff,0 0 18px rgba(55,210,249,.06)}

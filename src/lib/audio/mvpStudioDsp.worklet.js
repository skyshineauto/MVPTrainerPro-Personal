import { MvpMasterPrepProcessor } from "./mvpMasterPrepDsp.js";

// MVP Trainer Pro - MVP Studio WASM AudioWorklet V6.2 R78 Audio Intelligence
  ...
  async initialize(wasmBytes) {
    ...
    try {
      ...
      this.port.postMessage({
        ...
        version: "studio-wasm-v6.2-r78-audio-intelligence-r77i-core",
      });
    } catch (error) {
      this.failed = true;
      this.port.postMessage({

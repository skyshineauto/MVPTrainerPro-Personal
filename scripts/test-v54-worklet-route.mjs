...
if (Number(ready.engineBuildId) !== 5900) {
  throw new Error(
...
if (Number(ack.engineBuildId) !== 5900) {
  throw new Error(
...
if (Number(muteAck.engineBuildId) !== 5900) {
  throw new Error(
...
if (
  ...
  Number(pong.engineBuildId) !== 5900
) {
  throw new Error(
...
for (const outputProfile of [
  ...
  for (const mode of [
    ...
    for (let mask = 0; mask < 16; mask += 1) {
      ...
      if (
        Number(stateAck.engineBuildId) !== 5900 ||

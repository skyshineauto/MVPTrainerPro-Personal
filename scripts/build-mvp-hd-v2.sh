...
CXX="${CXX:-clang++}"
mkdir -p "$(dirname "$OUT")"
"$CXX" --target=wasm32 -std=c++20 -O3 -fno-exceptions -fno-rtti -fno-builtin -nostdlib "$SRC" \
  -Wl,--no-entry -Wl,--export-memory -Wl,--initial-memory=8388608 -Wl,--max-memory=8388608 \
  -Wl,--export=mvp_v2_input_l -Wl,--export=mvp_v2_input_r -Wl,--export=mvp_v2_output_l -Wl,--export=mvp_v2_output_r \
  -Wl,--export=mvp_v2_max_frames -Wl,--export=mvp_v2_init -Wl,--export=mvp_v2_reset -Wl,--export=mvp_v2_reset_meters \
  -Wl,--export=mvp_v2_set_mode -Wl,--export=mvp_v2_set_output_profile -Wl,--export=mvp_v2_set_intensity \
  -Wl,--export=mvp_v2_set_bass_enabled -Wl,--export=mvp_v2_set_bass_character -Wl,--export=mvp_v2_set_impact_enabled \
  -Wl,--export=mvp_v2_set_clarity_enabled -Wl,--export=mvp_v2_set_spatial_enabled -Wl,--export=mvp_v2_set_space_mode \
  ...
  -Wl,--export=mvp_v2_meter_bass_activity_db -Wl,--export=mvp_v2_meter_clarity_activity_db -Wl,--export=mvp_v2_meter_spatial_width_percent \
  -Wl,--allow-undefined -o "$OUT"
echo "Built $OUT"
